...
class HumanThreatModel:
    ...
    def calculate_human_threat(self, years=70, n_steps=1000):      #################################################################################### Connect to years to R pls
        """
...
class AnimalThreatModel:
    ...
    def calculate_animal_threat(self, predator_level=None, initial_survival=1.0, time_span=70, n_steps=1000): ########################################################### Connect to time_span to R pls
        """
...
def analyze_external_threats(years=80): ################################################################################################################################################# Connect years to R pls
    ...
    human_time, human_risk, country = human_model.calculate_human_threat(years=years)
...
def run_complete_survival_analysis():
    """
    ...
    external_results = analyze_external_threats(years=70) ###################################################################################################################################### Update years to R pls
    ...
    environmental_data = get_environmental_risk_inputs()
...
if __name__ == "__main__":
    results = run_complete_survival_analysis()